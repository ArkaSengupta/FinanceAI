...
export default function IntraCompanyAnalysis() {
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="IndAS FS - Intra-Company Analysis Service Page"
      />
      <PageBreadcrumb pageTitle="IndAS FS - Intra-Company Analysis" />
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/[0.03] xl:px-10 xl:py-12">
        <div className="mx-auto w-full max-w-[800px]">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              Generate Intra Company Analytics
            </h1>
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Configure and generate intra-company analysis reports
            </p>
          </div>
