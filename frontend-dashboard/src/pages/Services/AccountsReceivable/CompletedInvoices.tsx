...
export default function CompletedInvoices() {
  ...
  const handleView = (id: number) => {
    console.log('View completed invoice with id:', id);
  };

  const handleDuplicate = (id: number) => {
    console.log('Duplicate completed invoice with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Completed Invoices Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Completed Invoices" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              View and manage completed client invoices
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading completed invoices...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No completed invoices found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} completed invoices
            </div>
