...
export default function AddInvoice() {
  ...
  const addLineItem = () => {
    ...
    const newLineItem: LineItem = {
      ...
      invoiceAmount: currentLineItem.invoiceAmount
    };
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log('Invoice data submitted for approval:', formData);
      
      // Navigate back to invoices list
      navigate('/services/accounts-receivable/completed-invoices');
    } catch (error) {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      console.log('Invoice saved as draft:', formData);
      
      // Navigate back to invoices list
      navigate('/services/accounts-receivable/draft-invoices');
    } catch (error) {
  ...
  const calculateAmounts = (quantity: string, rate: string, igstRate: string, cgstRate: string, sgstRate: string) => {
    ...
    const invoiceAmount = taxableValue + igstAmount + cgstAmount + sgstAmount;
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Add New Invoice"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Add New Invoice" />
                  ...
                  <DatePicker
                    ...
                    onChange={(dates, currentDateString) => {
                      ...
                      if (selectedDate >= today) {
                        handleInputChange('invoiceDate', currentDateString);
                      } else {
                        alert('Invoice date cannot be backdated. Please select today or a future date.');
                      }
                    }}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={currentLineItem.invoiceAmount}
                      onChange={(e) => {
                        setCurrentLineItem(prev => ({
                          ...prev,
