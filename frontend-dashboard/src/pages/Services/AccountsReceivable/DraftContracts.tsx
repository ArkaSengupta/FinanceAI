...
export default function DraftContracts() {
  ...
  const handleEdit = (id: number) => {
    console.log('Edit draft contract with id:', id);
  };
  ...
  const handleView = (id: number) => {
    console.log('View draft contract with id:', id);
  };

  const handleDuplicate = (id: number) => {
    console.log('Duplicate draft contract with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Draft Contracts Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Draft Contracts" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              View and manage draft client contracts
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading draft contracts...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No draft contracts found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} draft contracts
            </div>
