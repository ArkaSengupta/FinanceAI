...
export default function PendingApprovalUnbilledRevenue() {
  ...
  const handleView = (id: number) => {
    console.log('View pending approval unbilled revenue with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Pending Approval Unbilled Revenue Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Pending Approval Unbilled Revenue" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              Pending Approval Unbilled Revenue
            </h1>
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              Review and approve pending unbilled revenue entries
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading pending unbilled revenue...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No pending unbilled revenue found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} pending unbilled revenue entries
            </div>
