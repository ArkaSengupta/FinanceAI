...
export default function DraftUnbilledRevenue() {
  ...
  const handleEdit = (id: number) => {
    console.log('Edit draft unbilled revenue with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Draft Unbilled Revenue Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Draft Unbilled Revenue" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              Draft Unbilled Revenue
            </h1>
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              View and manage draft unbilled revenue entries
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading draft unbilled revenue...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No draft unbilled revenue found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} draft unbilled revenue entries
            </div>
