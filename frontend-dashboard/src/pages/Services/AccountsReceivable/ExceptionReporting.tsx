...
export default function ExceptionReporting() {
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Exception Reporting Service Page"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Exception Reporting" />
        ...
        <div className="mx-auto w-full max-w-[800px]">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Configure and generate exception reports for accounts receivable
            </p>
          </div>
