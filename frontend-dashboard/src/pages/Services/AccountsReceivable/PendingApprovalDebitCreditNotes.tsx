...
export default function PendingApprovalDebitCreditNotes() {
  ...
  const handleView = (id: number) => {
    console.log('View pending approval debit/credit note with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Pending Approval Debit/Credit Notes Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Pending Approval Debit/Credit Notes" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
              Pending Approval Debit/Credit Notes
            </h1>
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              View and manage pending approval debit and credit notes
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading pending approval debit/credit notes...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No pending approval debit/credit notes found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} pending approval debit/credit notes
            </div>
