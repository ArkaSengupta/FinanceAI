...
export default function PendingApprovalInvoices() {
  ...
  const handleView = (id: number) => {
    console.log('View pending approval invoice with id:', id);
  };
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Accounts Receivable - Pending Approval Invoices Management"
      />
      <PageBreadcrumb pageTitle="Accounts Receivable - Pending Approval Invoices" />
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-400">
              Review and approve pending client invoices
            </p>
          </div>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="flex items-center justify-center">
                        ...
                        <span className="ml-2 text-gray-600 dark:text-gray-400">Loading pending invoices...</span>
                      </div>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="px-5 py-8 text-center">
                      <div className="text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-lg font-medium">No pending invoices found</p>
        ...
        {!loading && pagination.totalPages > 1 && (
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {pagination.totalItems} pending invoices
            </div>
