...
export default function CompliancesAnalytics() {
  ...
  return (
    <div>
      <PageMeta
        title={pageMetaTitle}
        description="Compliances - Compliances Analytics Service Page"
      />
      <PageBreadcrumb pageTitle="Compliances - Compliances Analytics" />
        ...
        <div className="mx-auto w-full max-w-[800px]">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Configure and generate compliance analytics reports
            </p>
          </div>
